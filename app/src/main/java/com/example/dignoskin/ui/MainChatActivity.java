package com.example.dignoskin.ui;
...
import com.example.dignoskin.Adapters.ChatroomRecyclerAdapter;
import com.example.dignoskin.R;
import com.example.dignoskin.models.Chatroom;
...
import static com.example.dignoskin.Constants.ERROR_DIALOG_REQUEST;
...
//    private Set<Chatroom> mChatrooms = new HashSet<>();
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(MainChatActivity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(MainChatActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
        ...
        builder.setPositiveButton("CREATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(MainChatActivity.this, "Enter a chatroom name", Toast.LENGTH_SHORT).show();
                }
            }
        });
